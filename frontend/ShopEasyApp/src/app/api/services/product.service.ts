...
export class ProductService extends BaseService {
  ...
  apiProductIdPut(params: {
    ...
    return this.apiProductIdPut$Response(params).pipe(
  ...
  apiProductIdDelete$Plain(params: {
    ...
    return this.apiProductIdDelete$Plain$Response(params).pipe(
      map((r: StrictHttpResponse<Product>) => r.body as Product)
    );
  }
  ...
  apiProductIdDelete$Json(params: {
    ...
    return this.apiProductIdDelete$Json$Response(params).pipe(
      map((r: StrictHttpResponse<Product>) => r.body as Product)
    );
  }
